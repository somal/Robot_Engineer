...
"""autogenerated by genpy from motion_editor_core/ExecuteMotionCommand.msg. Do not edit."""
import sys
...
class ExecuteMotionCommand(genpy.Message):
  _md5sum = "baea61f0df386139ca78eeafc991b967"
  _type = "motion_editor_core/ExecuteMotionCommand"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Execute motion via topic	
string  motion_name	
float32 time_factor
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteMotionCommand, self).__init__(*args, **kwds)
