...
"""autogenerated by genpy from hector_worldmodel_msgs/Object.msg. Do not edit."""
import sys
...
class Object(genpy.Message):
  _md5sum = "02dea96e80640703553490052f13918d"
  _type = "hector_worldmodel_msgs/Object"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# hector_worldmodel_msgs/Object
...
"""
  __slots__ = ['header','pose','info','state']
  _slot_types = ['std_msgs/Header','geometry_msgs/PoseWithCovariance','hector_worldmodel_msgs/ObjectInfo','hector_worldmodel_msgs/ObjectState']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.info is None:
        self.info = hector_worldmodel_msgs.msg.ObjectInfo()
      if self.state is None:
        self.state = hector_worldmodel_msgs.msg.ObjectState()
    else:
      self.header = std_msgs.msg.Header()
      self.pose = geometry_msgs.msg.PoseWithCovariance()
      self.info = hector_worldmodel_msgs.msg.ObjectInfo()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_fb.pack(_x.info.support, _x.state.state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.info.support, _x.state.state,) = _struct_fb.unpack(str[start:end])
      return self
